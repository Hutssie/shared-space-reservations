...
export const Categories = () => {
  ...
  return (
    <section className="py-16 bg-brand-100/50 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-brand-700 mb-4 tracking-tight">Browse by category</h2>
          <p className="text-brand-500 font-medium max-w-xl mx-auto text-base">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-5">
          {categories.map((cat, idx) => (
            <Link 
              ...
              className="group flex flex-col items-center justify-center p-5 bg-white rounded-2xl border border-brand-200 hover:border-brand-400 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 shadow-sm cursor-pointer no-underline"
            >
              <div className="w-11 h-11 bg-brand-100 rounded-xl flex items-center justify-center mb-3 group-hover:bg-brand-500 transition-colors">
                <cat.icon className="w-5 h-5 text-brand-500 group-hover:text-white transition-colors" />
              </div>
